...
#include <iostream>
#include "../../fastjet-3.4.2/include/fastjet/ClusterSequence.hh"
...
// f77 interface to CDFMidPoint (via fastjet)
//
// Corresponds to the following Fortran subroutine
// interface structure:
//
//   SUBROUTINE FASTJETCDFMIDPOINT(P,NPART,R,F,F77JETS,NJETS)
...
void fastjetcdfmidpoint_(const double * p, const int & npart,                   
    ...
    fj::CDFMidPointPlugin * plugin = new fj::CDFMidPointPlugin(R,f);
